uma aplicação para registrar compras em um cartão de crédito. 


## 🔨 Objetivo do projeto

- uma classe que represente uma compra (descrição e valor);
- uma classe que represente um cartão de crédito (limite, saldo e lista de compras), sendo que ela deve possuir um método para registrar uma compra;
- uma classe com o método main, seguindo os seguintes objetivos:
